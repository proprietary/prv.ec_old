...
static addLookupKey(builder:flatbuffers.Builder, lookupKeyOffset:flatbuffers.Offset) {
  builder.addFieldOffset(2, lookupKeyOffset, 0);
};
...
static createShorteningResponse(builder:flatbuffers.Builder, version:number, error:boolean, lookupKeyOffset:flatbuffers.Offset):flatbuffers.Offset {
  ...
  ShorteningResponse.addLookupKey(builder, lookupKeyOffset);
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  const lookupKey = ec_prv.fbs.ShorteningResponse.createLookupKeyVector(builder, this.lookupKey);
